...
class EcMasterConfig:
    ...
    def get_robot_type_and_slave_num(self, robot_version):
        ...
        elif robot_version == 55:
            return "kuavo5_v55", 13
        elif robot_version == 56:
            return "kuavo5_v56", 13
        else:
    ...
    def get_ec_eni_config(self, driver_type, slave_num):
        if driver_type == "elmo":
            ...
            # 56
            if self.robot_version == 56:
                return f"./config/ENI_config/kuavo5_56_version.xml"
            if self.robot_version == 55:
                return f"./config/ENI_config/kuavo5_55_version.xml"
