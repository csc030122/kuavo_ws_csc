...
- 替换步骤(这里以左臂夹爪为例):
  ...
  - 拧掉红圈中的螺丝(两张图片,共五个)
  ![夹爪换灵巧手支架](images/夹爪换灵巧手支架1.png)
  ![夹爪换灵巧手支架](images/夹爪换灵巧手支架2.png)

  - 使用一字螺丝刀等工具,在箭头处一点点撬开结构件
  ![夹爪换灵巧手支架](images/夹爪换灵巧手支架3.png)
    
  - 撬开结构件后, 拧掉红圈中的螺丝(共四个)
  ![夹爪换灵巧手支架](images/夹爪换灵巧手支架4.png)
    
  - 按压箭头处将夹爪通信线取下,即可卸下夹爪
  ![夹爪换灵巧手支架](images/夹爪换灵巧手支架5.png)
