...
2. **frames**
   ...
   | **键名**      | **类型** | **描述**                                                                                                                                                                                                                                                                  |
   | ----------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | `servos`    | list   | 包含所有关节角度值的数组，关节序号与关节位置的映射关系，在此处[（KUAVO_4.1）](../../1产品介绍/KUAVO_4.1产品介绍.md#自由度范围、速度扭矩限制关节位置及运动控制坐标系图示)、[（KUAVO_4pro_长手版）](../../1产品介绍/产品介绍.md#kuavo_4pro_长手版自由度范围速度扭矩限制关节位置及运动控制坐标系图示)或[（KUAVO_4pro_短手版）](../../1产品介绍/产品介绍.md#kuavo_4pro_短手版自由度范围速度扭矩限制关节位置及运动控制坐标系图示)查看 |
