...
- [产品介绍](#产品介绍)
  - [产品组成](#产品组成)
  - [产品规格](#产品规格)
  - [KUAVO\_5-W进阶版自由度范围、速度扭矩限制关节位置及运动控制坐标系图示](#kuavo_5-w进阶版自由度范围速度扭矩限制关节位置及运动控制坐标系图示)
  - [KUAVO\_5-W进阶版电气接口](#kuavo_5-w进阶版电气接口)
    - [换电板接口说明：](#换电板接口说明)
    - [电源板接口说明:](#电源板接口说明)
  - [传感器参数](#传感器参数)
    - [IMU](#imu)
...
KUAVO轮臂机器人5代进阶版包含头、躯干、手臂，腰部全身总共36个自由度，使得机器人能够实现灵活的运动和姿态控制。
...
![KUAVO_5-W](images/五代_夹爪机器人_渲染图.png)
...
| 自由度  | 全身自由度<br/>颈关节<br/>单臂自由度<br/>二指爪<br/>腰部<br/>折叠臂<br/>底盘 | 36<br/>2<br/>7<br/>2<br/>1<br/>4<br/>3                          |
| 运行参数 | 行走速度<br/>行走模式                                                                    | 5.4km/h<br/>全向行走                                                      |
| 电池参数 | 工作电压<br/>电池容量<br/>充电方式                                | ≥48V<br/>60Ah+6Ah<br/>自动充、手动充电、手动换电                      |
| 传感器  | 摄像头<br/>麦克风<br/>激光雷达<br/>扬声器<br/>关节温度传感器<br/>IMU                        | 立体视觉相机（1280×800@30fps景深/红外，1280×800@60fps RGB）<br/>6MIC  360度定位（拾音距离3-5m）<br/>mid-360<br/>立体音响<br/>LB01<br/>俯仰/横滚0.2度，航向角漂移0.2度 |
| 算力平台 | 下位机<br/>上位机 | GENE-MTH6 x 1<br/>Orin-NX x 1 |
| 安全功能 | 本体急停<br/>声音提醒                                                           | 1<br/>低电量提醒                                                 |

![KUAVO_5-W](images/五代轮臂_夹爪机器人_产品规格图示.png)

## KUAVO_5-W进阶版自由度范围、速度扭矩限制关节位置及运动控制坐标系图示
